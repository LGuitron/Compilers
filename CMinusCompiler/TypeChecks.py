    ...
    if var_properties is not None:
        ...
        if var_properties[0] == "int":
            ...
            if "params" in var_properties[1]:
                return validate_parameters(node, var_properties, symbol_tables)
...
# Helper function to validate the parameters of a node function
def validate_parameters(node, var_properties, symbol_tables):
